    ...
    <main id="main" class="Main">
        <section>
            ...
            <div>
                ...
                <output id="Crono" style="padding: 0%; font-size: 18px;">0:00</output>
                <button id="Crono" style="background-color:#8241f9; text-shadow: 3px 2px 2px blue;">Classement</button>
                <ul>
